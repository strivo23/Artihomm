    ...
    <div>
      ...
      <footer>
        ...
        <div className="footer-socials">
          <a href="https://www.instagram.com/artihome.in?igsh=MTBnd2l4aWE4MzVxdA==" target="_blank" rel="noopener noreferrer" className="footer-social" title="Instagram">📷</a>
          <a href="https://wa.me/917989287158" target="_blank" rel="noopener noreferrer" className="footer-social" title="WhatsApp">💬</a>
        </div>
      </footer>
